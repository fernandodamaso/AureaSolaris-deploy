...
@router.get("/birth-profile", response_model=BirthProfileResponse, responses=PROBLEM_RESPONSES)
...
@router.put("/birth-profile", response_model=BirthProfileResponse, responses=PROBLEM_RESPONSES)
