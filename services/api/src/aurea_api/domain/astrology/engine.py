...
# Legacy calculation code is preserved byte-for-byte; style modernization is
# intentionally out of scope for the relocation task.
# ruff: noqa: E402, E501, I001, UP006, UP007, UP015, UP017, UP035, UP037
...
# ──────────────────────────────────────────────────────
from .governance import EngineGovernance, GovernanceResult
...
def calculate_astrology(
    ...
    try:
        ...
        if ephemeris_mode != "swiss":
            return {"error": "Swiss Ephemeris fallback was detected; no natal chart was calculated."}
...
def _transit_core(
    ...
    try:
        ...
        if ephemeris_mode != "swiss":
            return {"error": "Swiss Ephemeris fallback was detected; no transit was calculated."}
